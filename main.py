...
class CRUDApp:
    ...
    def update_employee(self):
        ...
        new_name = simpledialog.askstring("Update Employee", "Enter the new name:")
        ...
        # Update the employee's name and salary in the database
        self.cursor.execute("UPDATE employees SET emp_name = %s, emp_salary = %s WHERE emp_id = %s", (new_name, new_salary, emp_id))
        self.conn.commit()
